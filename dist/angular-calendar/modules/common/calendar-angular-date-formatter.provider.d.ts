...
export declare class CalendarAngularDateFormatter implements CalendarDateFormatterInterface {
    ...
    eventStartDateTitle({ date, locale, }: DateFormatterParams): string;
    eventStartTimeTitle({ date, locale, }: DateFormatterParams): string;
    eventEndTimeTitle({ date, locale, }: DateFormatterParams): string;
}
