...
export declare class CalendarMonthViewComponent implements OnChanges, OnInit, OnDestroy {
     ...
     * @hidden
     */
    trackByDate: (index: number, day: MCMonthViewDay<any>) => string;
    /**
     * @hidden
     */
    ngOnInit(): void;
     ...
     * @hidden
     */
    eventDropped(droppedOn: MCMonthViewDay, event: MCEvent, draggedFrom?: MCMonthViewDay): void;
